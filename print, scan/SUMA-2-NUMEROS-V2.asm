...
section .data					
	...
	msj3	db		"la suma de %lld y de %lld es: %lld", 10, 0
...
;----------------------
	mov rax, [numero1]	
	add rax, [numero2]
	mov [suma], rax	 ;suma=numero1+numero2

;--- printf("la suma de %lld y de %lld es: %lld", numero1, numero2, suma); ------	
	mov r9, [suma]	 ; valor
	mov r8, [numero2]; valor
	mov rdx,[numero1]; valor
